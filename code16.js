...
{for(var i = 0, len = gdjs.Percurso_32CarmoCode.GDpercursoObjects2.length ;i < len;++i) {
    gdjs.Percurso_32CarmoCode.GDpercursoObjects2[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(7)) + 4);
}
}}
...
};gdjs.Percurso_32CarmoCode.userFunc0x11e6e00 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32CarmoCode.userFunc0x11e6e70 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32CarmoCode.userFunc0x11e6e00(runtimeScene);
...
gdjs.Percurso_32CarmoCode.userFunc0x11e6e70(runtimeScene);
