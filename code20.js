...
{for(var i = 0, len = gdjs.Percurso_32BrasileiraCode.GDpercursoObjects2.length ;i < len;++i) {
    gdjs.Percurso_32BrasileiraCode.GDpercursoObjects2[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(7)) + 4);
}
}}
...
};gdjs.Percurso_32BrasileiraCode.userFunc0xa096c8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32BrasileiraCode.userFunc0xa09738 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
};gdjs.Percurso_32BrasileiraCode.eventsList7 = function(runtimeScene) {
...
gdjs.Percurso_32BrasileiraCode.userFunc0xa096c8(runtimeScene);
...
gdjs.Percurso_32BrasileiraCode.userFunc0xa09738(runtimeScene);
...
{ //Subevents
gdjs.Percurso_32BrasileiraCode.eventsList6(runtimeScene);} //End of subevents
}
...
gdjs.Percurso_32BrasileiraCode.eventsList7(runtimeScene);
gdjs.Percurso_32BrasileiraCode.GDnoObjects1.length = 0;
gdjs.Percurso_32BrasileiraCode.GDnoObjects2.length = 0;
gdjs.Percurso_32BrasileiraCode.GDnoObjects3.length = 0;
gdjs.Percurso_32BrasileiraCode.GDyesObjects1.length = 0;
