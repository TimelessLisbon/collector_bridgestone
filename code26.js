...
{for(var i = 0, len = gdjs.Percurso_32BicaCode.GDpercursoObjects2.length ;i < len;++i) {
    gdjs.Percurso_32BicaCode.GDpercursoObjects2[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(7)) + 4);
}
}}
...
};gdjs.Percurso_32BicaCode.userFunc0x11904f8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32BicaCode.userFunc0x1190568 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.copyArray(runtimeScene.getObjects("next_scene"), gdjs.Percurso_32BicaCode.GDnext_9595sceneObjects1);
{for(var i = 0, len = gdjs.Percurso_32BicaCode.GDnext_9595sceneObjects1.length ;i < len;++i) {
    gdjs.Percurso_32BicaCode.GDnext_9595sceneObjects1[i].setString("Bica Fim2");
}
}}
...
gdjs.Percurso_32BicaCode.userFunc0x11904f8(runtimeScene);
...
gdjs.Percurso_32BicaCode.userFunc0x1190568(runtimeScene);
