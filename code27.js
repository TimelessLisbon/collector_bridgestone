...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19396212);
}
if (isConditionTrue_0) {
...
};gdjs.Percurso_32CamoesCode.userFunc0x11cc938 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32CamoesCode.userFunc0x11cc9a8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19414620);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19416532);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19418892);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "click-21156.mp3", false, 100, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19425748);
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField(gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), "Score", gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(1)), runtimeScene.getScene().getVariables().get("error"));
}}
...
gdjs.Percurso_32CamoesCode.userFunc0x11cc938(runtimeScene);
...
gdjs.Percurso_32CamoesCode.userFunc0x11cc9a8(runtimeScene);
...
gdjs.Percurso_32CamoesCode.eventsList6(runtimeScene);
