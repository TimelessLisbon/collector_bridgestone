...
{for(var i = 0, len = gdjs.Percurso_32Sta_32CatarinaCode.GDpercursoObjects2.length ;i < len;++i) {
    gdjs.Percurso_32Sta_32CatarinaCode.GDpercursoObjects2[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(7)) + 4);
}
}}
...
{for(var i = 0, len = gdjs.Percurso_32Sta_32CatarinaCode.GDpercursoObjects1.length ;i < len;++i) {
    gdjs.Percurso_32Sta_32CatarinaCode.GDpercursoObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(7)));
}
}}
...
};gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x11df778 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x11df7e8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
}{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, (( gdjs.Percurso_32Sta_32CatarinaCode.GDnext_9595sceneObjects1.length === 0 ) ? "" :gdjs.Percurso_32Sta_32CatarinaCode.GDnext_9595sceneObjects1[0].getString()), false);
}}
...
}{runtimeScene.getScene().getVariables().get("latif").setNumber(38.7091);
}{runtimeScene.getScene().getVariables().get("latsup").setNumber(38.7099);
}{runtimeScene.getScene().getVariables().get("longsup").setNumber(-(9.1472));
}{runtimeScene.getScene().getVariables().get("longinf").setNumber(-(9.1480));
...
gdjs.copyArray(runtimeScene.getObjects("gmaps"), gdjs.Percurso_32Sta_32CatarinaCode.GDgmapsObjects1);
{for(var i = 0, len = gdjs.Percurso_32Sta_32CatarinaCode.GDgmapsObjects1.length ;i < len;++i) {
    gdjs.Percurso_32Sta_32CatarinaCode.GDgmapsObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(7)));
}
}}
...
gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x11df778(runtimeScene);
...
gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x11df7e8(runtimeScene);
